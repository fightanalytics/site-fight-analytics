    ...
    <section class="features">
        ...
        <article>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="">
                      <div class="card-sm col-md-4 col-sm-4 col-xs-4">
        ...
        <article>
            ...
            <div class="header-section">
                <h2 class="title-header-section">Also, they works in all sizes.</h2>
                <p class="subtitle-header-section">We combine real time monitoring statistics of every fight, specialized data and a innovative technology behind it to delivery for your site the best fit with your content and what your audience are looking for: </p>
            </div>
            ...
            <div class="container">
                ...
                <div class="row product-anchor" id="ufc-live-stats">
                  <div class="card-lg">
                ...
                <div class="row product-anchor" id="ufc-fight-stats">
                  <div class="card-lg ">
                    <div class="col-sm-8">
                ...
                <div class="row product-anchor" id="dashboard">
                  <div class="card-lg ">
                    <div class="col-sm-4">
                        <div class="text text-1">
                            <div class="header-text">
